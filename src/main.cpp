...
//    double Ax_Lim = 9.5;
    ...
    // PathPlanning pp(map_waypoints_s,map_waypoints_x,map_waypoints_y);//
  // h.onMessage([&pp,&lane, &ref_vel, &currentState, &prev_lane, &map_waypoints_x,&map_waypoints_y,&map_waypoints_s,&map_waypoints_dx,&map_waypoints_dy](uWS::WebSocket<uWS::SERVER> ws, char *data, size_t length,
  //                    uWS::OpCode opCode)
...
//              // TODO: define a path made up of (x,y) points that the car will visit sequentially every .02 seconds
            ...
            // vector<vector<double>> trajectory = pp.choose_next_state(sensor_fusion, prev_lane, lane, currentState, car_state_traj, prev_path_XY, ref_vel);
            // cout << "Finished" << endl;
